        ...
        blocks: [
          {
            kind: "paragraph",
            text: [
              "The Book is narrative for the ",
              { code: "Echo 2026" },
              " edition. Canonical form sheets: ",
              { code: "/docs" },
              ". Spec table of contents: ",
              { code: "/e26/spec" },
              ". Executable contract: ",
        ...
        blocks: [
          {
            ...
            text: [
              { code: "Language Spec" },
              " — table of contents for public rules (Reference pages + suite areas). ",
              { code: "Run" },
              " — invoke the suite. ",
              { code: "Layout" },
              " — fixture file naming. ",
        ...
        blocks: [
          {
            ...
            text: [
              { code: "Echo 2026" },
              " is the language edition. Public law has two layers: the form-by-form ",
              { code: "Reference" },
              " (",
              { code: "/docs" },
              ") and the machine-checked ",
              { code: "echo26/" },
              " suite. This page indexes both. Narrative motivation lives in the ",
              { code: "Book" },
              " (",
              { code: "/book" },
              ").",
        ...
        blocks: [
          {
            kind: "paragraph",
            text: [
              "Form sheets for the Echo 2026 surface. Open a page for exact rules; open the matching Book chapter for why and when.",
            ],
          },
          {
            kind: "paragraph",
