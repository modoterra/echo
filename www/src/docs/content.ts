        ...
        blocks: [
          {
            ...
            text: [
              ...
              { code: "!" },
              " returns the error payload and leaves the process running. ",
              { code: "^ v" },
              " is ok. ",
              { code: "! e" },
              " is err.",
        ...
        blocks: [
          {
            ...
            text: [
              ...
              ". ",
              { code: "/ runtime" },
              " is allowed only in privileged std sources.",
            ],
          },
        ],
      },
...
xo ir --diag-codes src/main.echo`,
          },
          {
            kind: "paragraph",
            text: [
              "If lexing fails, later stages have no trustworthy source structure. When AST output succeeds and check fails, focus on names, kinds, effects, and module rules. IR emission also exercises HIR, MIR, and LLVM code generation.",
            ],
          },
        ],
      },
