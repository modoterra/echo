...
try {
  ...
  const { currentPrereleaseTag, currentPrereleaseAssets, currentPrereleaseUrl, releasesIndexUrl } =
    release;
  if (currentPrereleaseTag !== "v0.0.1-alpha.10") {
    fail(`currentPrereleaseTag should be v0.0.1-alpha.10, got ${currentPrereleaseTag}`);
  }
  ...
  for (const needle of ["Public facts", "prerelease tags", "MIT license", "v0.0.1-alpha.10"]) {
