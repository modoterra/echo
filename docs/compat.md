...
| `do-while` statements | partial | Parser/AST support covers the `do { } while ($condition);` statement shell. Non-empty bodies, complex parenthesized conditions, and runtime loop execution are deferred. Source: https://www.php.net/manual/en/control-structures.do.while.php |
