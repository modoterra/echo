...
| `declare` | partial | Parser/AST support covers `declare(directive=value);` with comma-separated directives. Braced/statement/alternate forms, literal-only directive validation, and runtime directive behavior are deferred. Source: https://www.php.net/manual/en/control-structures.declare.php |
