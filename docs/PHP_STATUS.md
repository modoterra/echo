...
- PHP compatibility fixtures: 246 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 279.
- Remaining Core + standard functions in inventory: 328.
...
coverage alone is `279 / 607`, or about 46%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~34% | Core + standard function coverage is 279/607, with deeper object/error/extension behavior still missing. |
