...
coverage alone is `289 / 607`, or about 48%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 289/607, with deeper object/error/extension behavior still missing. |
