...
- PHP compatibility fixtures: 339 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 388.
- Remaining Core + standard functions in inventory: 219.
...
coverage alone is `388 / 607`, or about 64%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~36% | Core + standard function coverage is 388/607, with deeper object/error/extension behavior still missing. |
