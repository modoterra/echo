...
- PHP compatibility fixtures: 320 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 361.
- Remaining Core + standard functions in inventory: 246.
...
coverage alone is `361 / 607`, or about 59%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 361/607, with deeper object/error/extension behavior still missing. |
