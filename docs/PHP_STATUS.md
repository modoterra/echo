...
- PHP compatibility fixtures: 196 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 213.
- Remaining Core + standard functions in inventory: 394.
...
coverage alone is `213 / 607`, or about 35%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~31% | Core + standard function coverage is 213/607, with deeper object/error/extension behavior still missing. |
...
- `[ ]` Raise implemented baseline count beyond 213/607.
