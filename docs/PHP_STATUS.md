...
- PHP compatibility fixtures: 337 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 386.
- Remaining Core + standard functions in inventory: 221.
...
coverage alone is `386 / 607`, or about 64%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~36% | Core + standard function coverage is 386/607, with deeper object/error/extension behavior still missing. |
