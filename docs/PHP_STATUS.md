...
- PHP compatibility fixtures: 237 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 270.
- Remaining Core + standard functions in inventory: 337.
...
coverage alone is `270 / 607`, or about 44%, for the Core + standard baseline,
