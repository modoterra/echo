...
- PHP compatibility fixtures: 228 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 261.
- Remaining Core + standard functions in inventory: 346.
...
coverage alone is `261 / 607`, or about 43%, for the Core + standard baseline,
