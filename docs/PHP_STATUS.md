...
- PHP compatibility fixtures: 296 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 331.
- Remaining Core + standard functions in inventory: 276.
...
coverage alone is `331 / 607`, or about 55%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 331/607, with deeper object/error/extension behavior still missing. |
