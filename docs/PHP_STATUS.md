...
- PHP compatibility fixtures: 295 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 330.
- Remaining Core + standard functions in inventory: 277.
...
coverage alone is `330 / 607`, or about 54%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 330/607, with deeper object/error/extension behavior still missing. |
