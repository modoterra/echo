...
coverage alone is `310 / 607`, or about 51%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 310/607, with deeper object/error/extension behavior still missing. |
