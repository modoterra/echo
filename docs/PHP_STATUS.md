...
- PHP compatibility fixtures: 318 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 359.
- Remaining Core + standard functions in inventory: 248.
...
coverage alone is `359 / 607`, or about 59%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 359/607, with deeper object/error/extension behavior still missing. |
