...
- PHP compatibility fixtures: 234 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 267.
- Remaining Core + standard functions in inventory: 340.
...
coverage alone is `267 / 607`, or about 44%, for the Core + standard baseline,
