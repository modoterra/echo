...
- PHP compatibility fixtures: 227 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 260.
- Remaining Core + standard functions in inventory: 347.
...
coverage alone is `260 / 607`, or about 43%, for the Core + standard baseline,
