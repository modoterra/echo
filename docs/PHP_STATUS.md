...
- PHP compatibility fixtures: 229 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 262.
- Remaining Core + standard functions in inventory: 345.
...
coverage alone is `262 / 607`, or about 43%, for the Core + standard baseline,
