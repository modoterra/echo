...
coverage alone is `305 / 607`, or about 50%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 305/607, with deeper object/error/extension behavior still missing. |
