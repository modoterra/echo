...
- PHP compatibility fixtures: 287 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 320.
- Remaining Core + standard functions in inventory: 287.
...
coverage alone is `320 / 607`, or about 53%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 320/607, with deeper object/error/extension behavior still missing. |
