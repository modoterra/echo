...
- PHP compatibility fixtures: 300 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 337.
- Remaining Core + standard functions in inventory: 270.
...
coverage alone is `337 / 607`, or about 56%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 337/607, with deeper object/error/extension behavior still missing. |
