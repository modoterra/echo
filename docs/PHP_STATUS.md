...
- PHP compatibility fixtures: 233 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 266.
- Remaining Core + standard functions in inventory: 341.
...
coverage alone is `266 / 607`, or about 44%, for the Core + standard baseline,
