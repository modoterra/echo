...
- PHP compatibility fixtures: 230 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 263.
- Remaining Core + standard functions in inventory: 344.
...
coverage alone is `263 / 607`, or about 43%, for the Core + standard baseline,
