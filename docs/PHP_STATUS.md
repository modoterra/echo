...
- PHP compatibility fixtures: 226 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 259.
- Remaining Core + standard functions in inventory: 348.
...
coverage alone is `259 / 607`, or about 43%, for the Core + standard baseline,
