...
- PHP compatibility fixtures: 288 `tests/php/*/program.php` files.
- Echo fixtures: 90 `tests/echo/*/program.echo` files.
- Core + standard PHP functions in inventory: 607.
- Implemented Core + standard functions in inventory: 321.
- Remaining Core + standard functions in inventory: 286.
...
coverage alone is `321 / 607`, or about 53%, for the Core + standard baseline,
...
| Runtime behavior and built-ins | 35% | ~35% | Core + standard function coverage is 321/607, with deeper object/error/extension behavior still missing. |
