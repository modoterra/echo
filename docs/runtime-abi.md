...
declare %EchoValue @echo_php_microtime(%EchoValue)
declare %EchoValue @echo_php_gettimeofday(%EchoValue)
declare %EchoValue @echo_php_hrtime(%EchoValue)
declare %EchoValue @echo_php_chdir(%EchoValue)
declare %EchoValue @echo_php_getcwd()
declare void @echo_php_clearstatcache(%EchoValue, %EchoValue)
...
declare %EchoValue @echo_php_cli_get_process_title()
declare %EchoValue @echo_php_cli_set_process_title(%EchoValue)
...
declare %EchoValue @echo_php_get_cfg_var(%EchoValue)
declare %EchoValue @echo_php_ini_get(%EchoValue)
declare %EchoValue @echo_php_ini_get_all(%EchoValue, %EchoValue)
declare %EchoValue @echo_php_ini_parse_quantity(%EchoValue)
declare %EchoValue @echo_php_get_include_path()
declare %EchoValue @echo_php_connection_aborted()
declare %EchoValue @echo_php_connection_status()
declare %EchoValue @echo_php_ignore_user_abort(%EchoValue)
declare %EchoValue @echo_php_headers_list()
declare %EchoValue @echo_php_headers_sent()
declare void @echo_php_header(%EchoValue, %EchoValue, %EchoValue)
declare void @echo_php_header_remove(%EchoValue)
declare %EchoValue @echo_php_http_response_code(%EchoValue)
declare %EchoValue @echo_php_ini_set(%EchoValue, %EchoValue)
declare %EchoValue @echo_php_ini_alter(%EchoValue, %EchoValue)
declare void @echo_php_ini_restore(%EchoValue)
declare %EchoValue @echo_php_php_ini_loaded_file()
declare %EchoValue @echo_php_php_ini_scanned_files()
