...
pub(crate) fn reflections() -> Vec<FunctionReflection> {
    [
        ...
        php_builtin_reflection("exec", &[("command", Some("string"))], Some("string|false")),
        php_builtin_reflection(
            "system",
            &[("command", Some("string"))],
            Some("string|false"),
        ...
        php_builtin_reflection(
            "ob_get_status",
            &[("full_status", Some("bool"))],
            Some("array"),
        ),
        php_builtin_reflection("ob_list_handlers", &[], Some("array")),
        php_builtin_reflection(
            "output_add_rewrite_var",
            &[("name", Some("string")), ("value", Some("string"))],
            Some("bool"),
        ),
        ...
        php_builtin_reflection(
            ...
            &[("image_type", Some("int")), ("include_dot", Some("bool"))],
            Some("string|false"),
        ),
        php_builtin_reflection(
        ...
        php_builtin_reflection(
            "ftok",
            &[("filename", Some("string")), ("project_id", Some("string"))],
            Some("int"),
        ),
        php_builtin_reflection(
            "file_get_contents",
