...
use echo_codegen_abi::{
    ...
    RT_HEX_ENCODE, RT_HMAC_SHA256, RT_JSON_PARSE, RT_JSON_STRINGIFY, RT_LOCATOR_CLASS,
    RT_MATH_ABS_F, RT_MATH_ABS_I, RT_MATH_CEIL, RT_MATH_COS, RT_MATH_FLOOR, RT_MATH_POW,
    RT_MATH_SIN, RT_MATH_SQRT, RT_MATH_TAN, RT_NOW_MONO_MS, RT_OS_CHDIR, RT_OS_CWD, RT_OS_HOSTNAME,
    RT_OS_PID, RT_OS_PLATFORM, RT_PARSE_F64, RT_PARSE_I64, RT_PATH_CLEAN, RT_PATH_REL,
    RT_PROCESS_PIPE_CLOSE, RT_PROCESS_PIPE_READ, RT_PROCESS_PIPE_WRITE, RT_PROCESS_RUN_CAPTURE,
    RT_PROCESS_RUN_CWD, RT_PROCESS_SPAWN_PIPES, RT_PROCESS_WAIT, RT_RANDOM_FLOAT, RT_RANDOM_SEED,
    RT_RANDOM_U64, RT_SHA256, RT_SHA512, RT_STR_REPLACE, RT_STR_SPLIT, RT_STR_TO_LOWER,
    RT_STR_TO_UPPER, RT_STR_TRIM, RT_TIME_FORMAT, RT_TIME_PARSE, RT_TLS_ACCEPT, RT_TLS_CLOSE,
    RT_TLS_CLOSE_LISTENER, RT_TLS_CONNECT, RT_TLS_LISTEN, RT_TLS_READ, RT_TLS_WRITE,
    RT_UNIX_ACCEPT, RT_UNIX_CLOSE, RT_UNIX_CONNECT, RT_UNIX_LISTEN, RT_UNIX_READ, RT_UNIX_WRITE,
    RT_URL_PARSE, RT_ZIP_PACK, RT_ZIP_UNPACK_FIRST,
};
...
pub fn runtime_ret_kind(name: &str) -> Option<&'static str> {
    match name {
        ...
        "str_len" | "bytes_len" | "str_get" | "bytes_get" | "locator_class" => Some("i64"),
        _ => None,
    }
}
