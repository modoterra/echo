pub(super) fn symbols() -> Vec<(&'static str, usize)> {
    vec![
        ...
        (
            "echo_php_str_increment",
            echo_runtime::echo_php_str_increment
                as extern "C" fn(echo_runtime::EchoValue) -> echo_runtime::EchoValue
                as usize,
        ),
        (
        ...
        (
            "echo_php_setlocale",
            echo_runtime::echo_php_setlocale
                as extern "C" fn(
                    echo_runtime::EchoValue,
                    echo_runtime::EchoValue,
                ) -> echo_runtime::EchoValue as usize,
        ...
        (
            "echo_php_localeconv",
            echo_runtime::echo_php_localeconv as extern "C" fn() -> echo_runtime::EchoValue
                as usize,
        ),
        (
            "echo_php_soundex",
        ...
        (
            ...
            echo_runtime::echo_php_utf8_encode
                as extern "C" fn(echo_runtime::EchoValue) -> echo_runtime::EchoValue
                as usize,
        ),
        (
            "echo_php_utf8_decode",
            echo_runtime::echo_php_utf8_decode
                as extern "C" fn(echo_runtime::EchoValue) -> echo_runtime::EchoValue
                as usize,
        ),
        (
            "echo_php_parse_url",
            echo_runtime::echo_php_parse_url
                as extern "C" fn(echo_runtime::EchoValue) -> echo_runtime::EchoValue
                as usize,
        ),
        (
        ...
        (
            "echo_php_html_entity_decode",
            echo_runtime::echo_php_html_entity_decode
                as extern "C" fn(echo_runtime::EchoValue) -> echo_runtime::EchoValue
                as usize,
        ),
        (
