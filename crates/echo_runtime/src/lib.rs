...
pub use string::{
    ...
    echo_php_htmlentities, echo_php_htmlspecialchars, echo_php_htmlspecialchars_decode,
    ...
    echo_php_quotemeta, echo_php_rtrim, echo_php_similar_text, echo_php_soundex,
    echo_php_str_contains, echo_php_str_ends_with, echo_php_str_ireplace, echo_php_str_pad,
