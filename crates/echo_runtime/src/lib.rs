...
pub use string::{
    ...
    echo_php_htmlspecialchars, echo_php_htmlspecialchars_decode, echo_php_implode,
    echo_php_lcfirst, echo_php_levenshtein, echo_php_ltrim, echo_php_nl2br, echo_php_ord,
