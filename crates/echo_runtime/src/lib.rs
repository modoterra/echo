...
pub use collections::{
    ...
    echo_php_array_slice, echo_php_array_sum, echo_php_array_values, echo_php_count,
    echo_php_in_array, echo_value_array_append, echo_value_array_key_at, echo_value_array_len,
    echo_value_array_new, echo_value_array_set, echo_value_array_value_at, echo_value_index_get,
