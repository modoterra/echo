...
pub use string::{
    ...
    echo_php_rtrim, echo_php_setlocale, echo_php_similar_text, echo_php_soundex,
    echo_php_str_contains, echo_php_str_decrement, echo_php_str_ends_with, echo_php_str_getcsv,
    echo_php_str_increment, echo_php_str_ireplace, echo_php_str_pad, echo_php_str_repeat,
    echo_php_str_replace, echo_php_str_rot13, echo_php_str_split, echo_php_str_starts_with,
    echo_php_str_word_count, echo_php_strcasecmp, echo_php_strcmp, echo_php_strcoll,
    ...
    echo_php_strstr, echo_php_strtok, echo_php_strtolower, echo_php_strtoupper, echo_php_strtr,
    echo_php_strval, echo_php_substr, echo_php_substr_compare, echo_php_substr_count,
    echo_php_substr_replace, echo_php_trim, echo_php_ucfirst, echo_php_ucwords, echo_php_wordwrap,
    echo_value_concat, echo_value_string,
};
