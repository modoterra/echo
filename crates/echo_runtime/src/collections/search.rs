...
#[unsafe(no_mangle)]
pub extern "C" fn echo_php_array_diff_assoc(array: EchoValue, other: EchoValue) -> EchoValue {
    if !array.is_array() || !other.is_array() {
        return EchoValue::error();
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn echo_php_array_intersect_assoc(array: EchoValue, other: EchoValue) -> EchoValue {
    if !array.is_array() || !other.is_array() {
        return EchoValue::error();
    }
